...
export default function Details({ strings,minimum_investment,expected_return ,fund_period}) {

    return (
        <>
            <div className='w-1/3 sm:p-6 p-4 text-center' style={{ backgroundColor: "#EEF5F9" }}>
                <p className='sm:text-xl text-base text-d-blue font-semibold' style={{ lineHeight: "2rem" }}>{minimum_investment} {strings.currency}</p>
