...
export default function Calculator({ locale, strings }) {
    ...
    return (
        <div className=''>
            <div className='mb-4 flex gap-14'>
                <div className={`w-1/2 flex items-center justify-between gap-6 ${locale == "ar" ? classes.root : ""}`}>
            ...
            <div className='my-4 flex items-center gap-14'>
                <hr className='w-5/6'/>
